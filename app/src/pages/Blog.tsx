    ...
    >
      ...
      <div style={{ position: 'relative', width: 180, height: 180 }}>
        ...
        >
          ...
          {/* Dark green arc ~75% */}
          <circle cx="90" cy="90" r="72" fill="none" stroke="#1B5E35" strokeWidth="28"
            strokeDasharray="340 452" strokeDashoffset="113" strokeLinecap="round" />
          {/* Light green arc ~15% */}
          <circle cx="90" cy="90" r="72" fill="none" stroke="#A8E6C0" strokeWidth="28"
          ...
          <circle cx="90" cy="90" r="44" fill="none" stroke="#1B5E35" strokeWidth="18"
            strokeDasharray="220 276" strokeDashoffset="69" strokeLinecap="round" />
          {/* Center button */}
          <circle cx="90" cy="90" r="24" fill="#1B5E35" />
      ...
      <div style={{ fontFamily: 'inherit', background: '#fff', minHeight: '100vh' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gridTemplateRows: '420px 300px', gap: 0, maxHeight: 720 }}>
          ...
          <div style={{ gridRow: '1 / 3', background: '#2D3A1E', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '3rem', position: 'relative', overflow: 'hidden' }}>
            ...
            <button onClick={() => setShowArticles(true)} style={{ background: '#ADDD5A', color: '#1a2a00', border: 'none', borderRadius: 8, padding: '14px 36px', fontSize: 15, fontWeight: 700, cursor: 'pointer', position: 'relative' }}>
              View All Articles
            </button>
          </div>
