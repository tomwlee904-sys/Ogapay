...
export default function Safe() {
  ...
  const statCards = [
    { icon: 'ti ti-vault', color: 'var(--accent)', count: stats.count, label: 'Documents' },
    { icon: 'ti ti-lock', color: 'var(--green)', count: stats.totalSize, label: 'Storage Used' },
    { icon: 'ti ti-shield-check', color: 'var(--accent)', count: stats.verified, label: 'Verified' },
  ]

  return (
    <Layout>
      <div style={S.hero}>
        <div style={S.greeting}>Document Vault</div>
        <h1 style={S.title}>Safe</h1>
        <p style={S.sub}>Upload and manage your important documents securely</p>
      </div>
