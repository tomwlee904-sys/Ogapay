...
const initialNotifications = [
  ...
  { id: 2, icon: 'ti ti-check', title: 'Task Approved', desc: 'Your submission for Content Review has been approved', time: '1h ago', read: false, color: '#52525b' },
  { id: 3, icon: 'ti ti-wallet', title: 'Withdrawal Processed', desc: 'Your withdrawal of NGN 2,000 has been sent', time: '3h ago', read: false, color: '#52525b' },
  ...
  { id: 6, icon: 'ti ti-bullhorn', title: 'Platform Update', desc: 'New features have been added to the platform', time: '2d ago', read: true, color: '#52525b' },
