...
const stats = [
  { icon: 'ti ti-vault', color: '#52525b', count: '5', label: 'Documents' },
  { icon: 'ti ti-lock', color: '#16a34a', count: '14 MB', label: 'Storage Used' },
  { icon: 'ti ti-shield-check', color: '#52525b', count: '4', label: 'Verified' },
]
  ...
  return (
    <Layout>
      <style>{`
        ...
        .vt-hero h1{font-family:Geist;font-size:28px;font-weight:900;margin:0 0 4px}
        ...
        .vt-stat .vt-num{font-family:Geist;font-size:24px;font-weight:900}
        ...
        .vt-upload-btn{height:38px;padding:0 14px;border-radius:10px;border:0;background:var(--accent);color:var(--on-accent);font-weight:700;font-size:12px;display:inline-flex;align-items:center;gap:6px;cursor:pointer;transition:all .2s}
        .vt-upload-btn:hover{box-shadow:0 4px 16px rgba(var(--accent-rgb),.2)}
