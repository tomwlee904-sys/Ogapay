...
export default function FAQ() {
  ...
  return (
    <Layout>
      <style>{`
        .faq-hero{text-align:center;padding:32px 20px 24px;margin-bottom:24px;background:linear-gradient(135deg,rgba(var(--accent-rgb),.05),var(--card));border-radius:16px;border:1px solid var(--border)}
        .faq-hero h1{font-family:Geist;font-size:32px;font-weight:900;margin:0 0 8px}
        ...
        .faq-cat:hover,.faq-cat.active{border-color:var(--accent);background:rgba(var(--accent-rgb),.04)}
        ...
        .faq-pop-title{font-family:Geist;font-size:15px;font-weight:800;margin-bottom:10px}
