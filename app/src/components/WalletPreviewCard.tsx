...
const OGAPAY_BLUE_MUTED = 'rgba(25,28,107,0.08)'
const GREEN = '#16a34a'
    ...
    <div style={{ marginTop: 16 }}>
      ...
      <div style={{ background: 'var(--bg)', border: '1px solid var(--border)', borderRadius: 10, padding: '0 14px', marginBottom: 10 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 0', borderBottom: '1px solid var(--border)' }}>
          ...
          <span style={{ fontSize: 13, fontWeight: 700 }}>{formatPay(heldAmt)} $PAY</span>
        </div>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 0', borderBottom: '1px solid var(--border)' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 0' }}>
          ...
          <div style={{ textAlign: 'right' as const }}>
            <div style={{ fontSize: 13, fontWeight: 700 }}>{formatPay(estPay)} $PAY</div>
